...
1. Explain what a token is used for. 
    A token is like a ticket or pass used to bypass the security for a website. Only certain tokens are allowed in.

2. What steps can you take in your web apps to keep your data secure?
    Two factor authenticators, and CAPTCHA systems to prevent bots.

3. Describe how web servers work.
    On the web server, HTTP servers are responsible for processing and answering all incoming requests.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
    POST, GET, PUT, DELETE, Create, Update, Read 